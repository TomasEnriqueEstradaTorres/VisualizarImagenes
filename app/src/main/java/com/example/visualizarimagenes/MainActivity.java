...
public class MainActivity extends AppCompatActivity {
    ...
    private Bitmap referenciaBitmap, bitmap1, bitmap2, bitmap3, bitmap4, pruebaBBBB; // para obtener referencia de comparacion de imagenes
    ...
    public void onResume() {
        ...
        opcion1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                opcion1.setImageResource(R.drawable.aventurero12);
                bitmap1 = ((BitmapDrawable)opcion1.getDrawable()).getBitmap();
                comprobarImagen(referenciaBitmap, bitmap1);
            }
        });
        ...
        opcion2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                opcion2.setImageResource(R.drawable.sombiea18);
        ...
        opcion3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                opcion3.setImageResource(R.drawable.sombieb24);
        ...
        opcion4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                opcion4.setImageResource(R.drawable.sombiea18);
    ...
    public void reiniciarJuego(){
        ...
        toastPersonalizado(mensajeReinicio);
        ...
        inter1.startAnimation(anim1);
        inter2.startAnimation(anim2);
        mensaje.setText(R.string.adivida); // reinicia el mensaje del juego
    }
    ...
    public void retornarImagen(){
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                ...
                opcion3.setImageResource(R.drawable.regalo);
                opcion4.setImageResource(R.drawable.regalo);
                mensaje.setText(R.string.adivida); // reinicia el mensaje
